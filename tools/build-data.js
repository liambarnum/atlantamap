...
const ACCESS_POINTS = [
  // --- Eastside Trail ---
  ['Piedmont Park — Park Tavern', 33.7818, -84.3712, 'eastside', 'park', ['restrooms', 'water', 'bus'], '10th St NE at Monroe Dr. Busiest entrance on the trail.'],
  ['Piedmont Park — North Woods', 33.7860, -84.3706, 'eastside', 'park', ['restrooms', 'water'], 'North end of the park, near the Northeast Trail junction.'],
  ['Monroe Drive at Virginia Ave', 33.7786, -84.3690, 'eastside', 'street', ['bus'], 'Street-level crossing.'],
  ['Amsterdam Walk', 33.7755, -84.3670, 'eastside', 'street', ['food'], 'Access from Amsterdam Ave NE.'],
  ['Ponce City Market', 33.7726, -84.3657, 'eastside', 'trailhead', ['restrooms', 'food', 'water', 'parking', 'bike-share'], 'Ramp and stairs to the Central Food Hall. Paid parking deck.'],
  ['Ponce de Leon Ave', 33.7712, -84.3656, 'eastside', 'street', ['bus'], 'Trail passes under Ponce; access via PCM ramp.'],
  ['North Avenue', 33.7700, -84.3655, 'eastside', 'street', [], 'Stair and ramp access.'],
  ['Historic Fourth Ward Park', 33.7666, -84.3660, 'eastside', 'park', ['restrooms', 'water', 'playground', 'parking'], 'Skate park, splash pad and the retention pond.'],
  ['Freedom Parkway / PATH', 33.7640, -84.3655, 'eastside', 'trailhead', ['bike-share'], 'Connects to the PATH Freedom Park Trail.'],
  ['Irwin Street', 33.7580, -84.3648, 'eastside', 'street', ['food'], 'Inman Park edge.'],
  ['Krog Street Market', 33.7554, -84.3646, 'eastside', 'trailhead', ['restrooms', 'food', 'bike-share'], 'Stairs down to Krog St NE and the tunnel.'],
  ['Wylie Street', 33.7525, -84.3640, 'eastside', 'street', [], 'Reynoldstown.'],
  ['Kirkwood Avenue', 33.7495, -84.3616, 'eastside', 'street', ['food'], 'Reynoldstown.'],
  ['Bill Kennedy Way', 33.7470, -84.3595, 'eastside', 'street', ['parking'], 'Street crossing with on-street parking.'],
  ['Memorial Drive', 33.7444, -84.3565, 'eastside', 'trailhead', ['bus'], 'Eastside/Southside junction.'],

  // --- Southside Trail ---
  ['Glenwood Avenue', 33.7405, -84.3562, 'southside', 'street', ['bus'], 'Street crossing.'],
